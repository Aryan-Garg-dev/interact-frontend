...
const NewResource = ({ setShow, organization, setShowResources, setResources }: Props) => {
  ...
  return (
    <>
      <div className="fixed top-1/2 -translate-y-1/2 w-[640px] max-md:w-5/6 backdrop-blur-2xl bg-white dark:bg-dark_primary_comp flex flex-col gap-4 rounded-lg p-10 max-md:p-5 dark:text-white font-primary border-[1px] border-primary_btn  dark:border-dark_primary_btn right-1/2 translate-x-1/2 animate-fade_third z-50">
        {tab === 0 ? (
          <>
