...
const EditOpening = ({ setShow, opening, setOpenings }: Props) => {
  ...
  return (
    <>
      <div className="fixed top-24 max-lg:top-20 w-[953px] max-lg:w-5/6 h-[540px] max-lg:h-2/3 backdrop-blur-2xl bg-white dark:bg-dark_primary_comp flex flex-col justify-between gap-4 rounded-lg p-8 dark:text-white font-primary overflow-y-auto border-[1px] border-gray-400  dark:border-dark_primary_btn right-1/2 translate-x-1/2 animate-fade_third z-30">
