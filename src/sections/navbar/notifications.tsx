...
const Notifications = ({ setShow }: Props) => {
  ...
  return (
    <>
      <div className="w-96 bg-gray-200 dark:bg-dark_primary_comp font-primary max-md:w-full max-h-[480px] max-md:max-h-none max-md:h-screen overflow-y-auto fixed top-[72px] max-md:top-0 right-4 max-md:right-0 rounded-2xl max-md:rounded-none backdrop-blur-lg backdrop flex flex-col items-center p-2 z-[150] animate-fade_third">
