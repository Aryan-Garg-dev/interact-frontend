...
const WhyChooseUs: React.FC<WhyChooseUsProps> = ({
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-[#0A2732] via-[#000000] to-[#0A2732] opacity-82 text-white px-4 py-16">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Cards Grid */}
        <div className="w-[80vw] mx-auto flex lg:flex-row flex-col justify-center gap-6 mb-16">
          {cards.map((card, index) => (
            <div
              key={index}
              className={`bg-[#1a1a1a] rounded-2xl p-8 sm:w-[75vw] backdrop-blur-lg bg-opacity-40 hover:bg-opacity-50 transition-all shadow-[0_10px_15px_#0A2732] ${
                index === 2 ? 'self-center' : ''
              }`}
            >
        ...
        <div className="w-[90vw] mx-auto mb-12">
          <div className="bg-[#1a1a1a] rounded-2xl p-8 bg-gradient-to-b from-[#000000] to-[#0A2732] bg-opacity-40">
