...
const NoOpenings = ({ width = 'full' }: Props) => {
  ...
  return (
    <div
      className={`w-${width} max-md:w-[90%] h-fit mx-auto px-12 max-md:px-8 py-8 rounded-md font-primary dark:text-white border-gray-300 border-[1px] bg-white dark:bg-dark_primary_comp hover:shadow-lg dark:hover:shadow-2xl flex-center flex-col gap-2 cursor-pointer transition-ease-500`}
    >
