...
const UserHoverCard = ({ user, title, scaleTransition = false }: Props) => {
  return (
    <div
      className={`w-2/3 bg-white dark:bg-dark_primary_comp_hover flex flex-col gap-2 rounded-xl p-4 shadow-xl absolute -translate-y-3/4 -top-2 opacity-0 group-hover:opacity-100 group-hover:-translate-y-full ${
